...
public:
  ...
  /**
   * Liefert "true", wenn der Sensor auf der primaeren/sekundaeren I2C Adresse gefunden wurde.
   * (original: Liefert aktuell gemessenen Wert für Helligkeit in lux (lx).)
   *
